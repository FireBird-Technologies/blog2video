"""Clamp over-limit FREE users' video usage to the free base (2 -> 1).

One-time data fix. The FREE base allowance was lowered again (2 -> 1), leaving
FREE users who had already consumed up to 2 videos with videos_used_this_period
(2) above their new video_limit (1). Because can_create_video is
...
This clamps videos_used_this_period down to the free base (1) for affected FREE
...
Revision ID: clamp_stranded_free_video_v2
Revises: add_lite_plan_tier
...
revision: str = "clamp_stranded_free_video_v2"
down_revision: Union[str, None] = "add_lite_plan_tier"
