...
**Never output a layout ID containing `__v`** (e.g. `marker_story__v2`) — those are visual variants assigned automatically by the system. Always output the plain base ID listed below.
