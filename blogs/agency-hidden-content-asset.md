...
- A strategist's time to pick the topic
- A writer's time to research and draft it
- An editor's time to review it
- A designer's time to format and publish it
...
| If you convert... | Videos Created | Revenue at $300/video | Production Cost |
|-------------------|---------------|----------------------|-----------------|
| Top 10 posts by traffic | 10 | $3,000 | ~$80 |
| Top 25 posts | 25 | $7,500 | ~$200 |
| Full archive (100 posts) | 100 | $30,000 | ~$800 |
...
Pull a list of the client's published posts sorted by organic traffic (Google Search Console) and organic keywords ranking in positions 4–20 (content with SEO momentum that video can compound). These are the posts most worth converting.

**Step 2: Prioritize by video fit**
Not all blog posts convert equally well. The best video candidates are:
- Explainer posts ("How X Works," "What Is X")
- List posts ("5 Ways to...," "The Best X for...")
- Process posts ("Step-by-Step Guide to...")
- Opinion/perspective posts with a clear argument

Long-form FAQ posts and glossary-style content work less well — they're too shallow on any single topic to sustain a video.

**Step 3: Convert using Blog2Video**
Paste the post URL into [Blog2Video](https://blog2video.app), select the matching template for the client's brand style, generate, review, export. 15–30 minutes per video once your workflow is established.

**Step 4: Distribute — don't just upload**
The video needs a home on YouTube with a proper title, description, tags, and end screen. It needs to be embedded back in the original blog post (increases time-on-page, which helps the post's existing rankings). It needs to be posted on LinkedIn as a native video post. Each of these is a 5-minute task per piece, not a full production sprint.
...
- Increases time-on-page for everyone who reads the post (better bounce signal for Google)
- Gives YouTube a second index for the same keyword
- Generates social sharing from the video that links back to the original post
- Creates watch time on YouTube that builds the client's channel authority
...
- *When did you last publish a video?* (If the answer is "months ago," their strategy isn't functioning.)
- *How much does your current video production cost?* (If it's over $500/video, you can reduce their cost and increase volume simultaneously.)
- *How long does it take from "we should make a video about this" to published?* (If it's more than a week, speed is your advantage.)
...
- **Client brief template:** brand voice, template preference, voice style, topics to avoid
- **Review checklist:** scene count, narration accuracy, branding check, export formats
- **Delivery template:** what goes to the client and how (MP4 direct, Dropbox folder, uploaded to their YouTube with their credentials)
- **Pricing sheet:** clear per-video pricing, package discounts, add-ons (YouTube optimization, embedding, social distribution)
