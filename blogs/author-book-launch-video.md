...
## Why the Trailer Formula Doesn't Perform
...
## Five Video Formats That Actually Sell Books
...
The structure:
- Open with the problem or observation that drove the book ("Most people think X. That's wrong.")
- State the thesis ("The research — and my interviews with 200 practitioners — shows that Y is what actually matters")
- Give one concrete example or data point that makes the thesis feel real
- Explain the implication ("If this is true, it means you should...")
- Close with the invitation ("The full argument is in [Book Title]")
...
## How to Produce These Videos From Your Book Content

Every one of these video formats can be produced from your existing book material — no new writing required.

Using [Blog2Video](https://blog2video.app):

**For the Thesis Video:**
- Paste the introduction or opening chapter of your book
- Select **Nightfall** or **Chronicle** (both signal serious, credible content)
- Generate and review — the AI will identify the key argument and structure it as narrated scenes

**For the Research Video:**
- Paste the key research sections from your book — the paragraphs where you introduce specific studies or data
- Select **Gridcraft** (clean, analytical, data-forward)
- The numbers will appear as data graphic overlays in the relevant scenes

**For the Framework Demo:**
- Paste the chapter where you explain your framework step by step
- Select **Geometric Explainer** (step-by-step visual layout)
- Each step becomes a distinct scene
...
## The Content Calendar for a Book Launch

Here's a video content schedule that creates sustained discovery without burning out:

**Months before launch:**
- **Month -2:** Thesis video (this is your anchor piece — gets shared most)
- **Month -1:** Origin story video + research video #1

**Launch month:**
- **Week 1:** Framework demo video
- **Week 2:** Research video #2 (different study/data point from book)
- **Week 3:** "Most surprising thing I found while writing this book"
- **Week 4:** Reader question video (respond to the first questions you're getting post-launch)

**Post-launch (months 2–6):**
- 2 videos per month from the chapter-by-chapter content (see the chapter framework in the companion piece on this site)
- One "response to feedback" video per quarter

**Month 12:**
- "What I got wrong / what I'd change" video
...
**How long should a book launch video be?**  
...
**Should the book's cover appear prominently in the video?**  
...
**How do I drive viewers from the video to actually buying?**  
...
**What if my publisher is handling my launch content?**  
...
**Is video more effective than podcast appearances for book launches?**  
