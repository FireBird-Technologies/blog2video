...
- **Your book's manuscript, published text, or a blog post/excerpt** — any form of your book's content in text format
- **A Blog2Video account** — [blog2video.app](https://blog2video.app); free to preview, $4 per exported video
- **A YouTube channel and/or LinkedIn profile** — where the video will be published
- **20–45 minutes** — total time per video from start to published

That's the full list. No camera, no microphone, no editing software.

---

## Step 1: Choose the Right Idea (10 minutes)
...
- Your book's central thesis (the argument that drove you to write it)
- Your most counterintuitive claim
- Your strongest case study or example
- A concept you invented or named that others haven't articulated this way

Mark 10–15 candidates. You'll produce them over time; you need one to start.

---

## Step 2: Prepare the Source Text (5 minutes)

Your source text is the section of your book that contains the idea. This might be:
- A chapter introduction (typically 300–600 words)
- A key subsection (200–500 words)
- Multiple paragraphs from across a chapter (combined into a single document)
...
2. **Expand abbreviations on first use.** If your book abbreviates a term after introducing it (e.g., "cognitive behavioral therapy (CBT)" → then uses "CBT"), the AI narration will speak abbreviations directly. Either spell them out throughout, or note the full term where it first appears.

These two adjustments take 5 minutes and meaningfully improve the output accuracy.

---

## Step 3: Open Blog2Video and Create a Project (2 minutes)

1. Go to [blog2video.app](https://blog2video.app) → Log in → **New Project**
2. Choose **Paste Text** (for manuscript excerpts) or **Paste URL** (for published articles/blog excerpts)
3. Enter a project title — use the video title you intend to publish, not the chapter title. This helps you stay organized when you have multiple projects from the same book.

---

## Step 4: Select a Template (3 minutes)
...
|----------|------------|
| **Nightfall** | Deep, narrative-driven ideas; content with cinematic emotional weight |
| **Spotlight** | Contrarian or provocative arguments; content with strong opinions |
| **Geometric Explainer** | Step-by-step frameworks; how-to content from the book |
| **Newscast** | Data-heavy findings; "here's what the research shows" content |
...
## Step 5: Choose a Voice (2 minutes)

Preview a few voices from the library and pick one that matches the tone of your book:
- Measured and authoritative → good for evidence-heavy or business content
- Conversational and warm → good for self-help or personal development content
- Crisp and analytical → good for research-based or strategy content
...
## Step 6: Generate and Review (8–12 minutes)
...
**For YouTube:** Export as MP4 (high quality)  
**For LinkedIn:** Same MP4 works as native video upload  
**For your author website:** The MP4 can be embedded directly  
**Optional:** Export as PDF slides for a companion LinkedIn carousel

---

## Step 8: Write the Title and Description (5 minutes)
...
## Step 9: Publish and Engage in the First 60 Minutes (5 minutes)

For LinkedIn specifically, the first hour after posting determines distribution. During that window:
- Reply to every comment, even briefly
- Ask a question in the comments yourself to seed engagement
- Share the post with a few colleagues who might genuinely find it useful
...
| Step | Activity | Time |
|------|----------|------|
| 1 | Choose idea from book | 10 min |
| 2 | Prepare source text | 5 min |
| 3 | Create Blog2Video project | 2 min |
| 4 | Select template | 3 min |
| 5 | Choose voice | 2 min |
| 6 | Generate + review | 10 min |
| 7 | Export | 1 min |
| 8 | Write title + description | 5 min |
| 9 | Publish + early engagement | 5 min |
| **Total** | | **~43 minutes** |
...
- Template and voice are already decided
- You know what level of review each video needs
- Title-writing becomes easier as you develop a pattern
...
**What if I publish an article or excerpt from my book first, then make a video? Or vice versa?**  
...
**Can I use this workflow for multiple books?**  
...
**What if my book's ideas are heavily visual — diagrams, flowcharts?**  
...
**How do I decide between YouTube-first vs. LinkedIn-first publishing?**  
...
**Can I batch-produce videos to avoid doing this every week?**  
