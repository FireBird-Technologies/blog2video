...
2. **A Blog2Video account** — [blog2video.app](https://blog2video.app), pay-per-video, no subscription required
...
## Content Selection: How to Pick the 12 Posts
...
3. Filter for content types that work best as video:
   - Explainers ("What is X," "How X Works")
   - Process guides ("How to do X step by step")
   - Comparison posts ("X vs. Y: Which is better?")
   - Analysis pieces with clear arguments or data points
...
## The Session: 12 Videos in 4 Hours

Here's the actual breakdown of the afternoon. You're processing roughly one video every 20 minutes.

### Hour 1: Videos 1–3

**Video 1 (45 min — calibration video)**  
The first video for any new client takes longer because you're establishing the production standard.

- Open Blog2Video → New Project → paste post 1 URL
- Select template based on client brand (if unsure, start with Gridcraft — it's neutral and professional)
- Set the voice and language
- Generate (2–3 min)
- Review every scene — read the narration, check the visual layout, note any issues
- If the template or voice isn't right, adjust and regenerate (5 min)
- Export MP4 + PDF + PNG
- Document the calibration: template name, voice name, any scenes you adjusted
- **Take 5 minutes to write a client "production brief"** — a single paragraph about what this client's video should look, sound, and feel like. You'll use this brief for all 11 remaining videos.

Calibration video total: ~45 minutes

**Videos 2–3 (30 min each)**  
You now have your production brief. The process is:
...
- Paste URL → generate → review → export → file

The review step is where most time goes. You're checking:
- **Accuracy** — did the AI represent the post's key points correctly?
- **Pacing** — does any scene feel too rushed or too slow?
- **Visual fit** — is the image selection appropriate for this client's industry?

Common quick fixes:
- A scene that needs its narration trimmed → edit the text field
- An image that's off-topic or mismatched → swap it
- A section the post glossed over that the AI over-expanded → remove the scene
...
**Videos 10–12 (15–20 min each)**  
By now the pattern is locked in. You're executing, not deciding.

**Delivery prep (30 min):**
- Rename all files with consistent naming convention
- Organize folders: MP4, PDF, PNG per video
- Write a short delivery note per video: what it covers, where it should be published (YouTube? LinkedIn? Embedded in the post?)
- Prepare a quick client-facing summary: "Here are 12 videos ready for distribution. Recommended publication schedule: 3/week over 4 weeks."
...
| Task | Time |
|------|------|
| Content selection (pre-session) | 30 min |
| Calibration video | 45 min |
| Videos 2–12 (11 × 20 min) | 220 min |
| Delivery prep | 30 min |
| **Total** | **~5.5 hours** |
...
**Cost breakdown:**
- Tool cost: 12 × $4 = $48
- Labor (at $75/hr blended rate): 5.5 × $75 = $412
- **Total production cost: ~$460**
- **Client billing at $350/video: $4,200**
- **Margin: ~$3,740 (89%)**
...
**Content accuracy:**
- [ ] Key claims in the video match the source post
- [ ] No statistics that are outdated or misrepresented
- [ ] Product names, company names, and proper nouns are correct

**Production quality:**
- [ ] No awkward narration cutoffs mid-sentence
- [ ] No scenes that are visually off-brand for this client
- [ ] Image selections are appropriate for the industry (no stock photo clichés on premium brand clients)
- [ ] Export is full resolution (not preview-quality)

**Distribution readiness:**
- [ ] MP4 exported for YouTube/LinkedIn
- [ ] PDF exported for LinkedIn carousel
- [ ] Files named properly with client and topic
- [ ] Delivery note written for each video
...
## What to Do With the Videos After Delivery
...
**What if the client wants to review all 12 before they're delivered?**  
...
**What's the right cadence to publish 12 videos?**  
...
**What if a client wants custom music in every video?**  
...
**How do we handle content that's time-sensitive or has been updated?**  
...
**Can one agency run this workflow across multiple clients simultaneously?**  
