...
> **TL;DR:** Around 200 volunteer Substack writers turned their posts into videos for two weeks. Total audience roughly 4x'd, new subscribers rose ~70%, and open rate improved ~20%. The lift came from distribution — publishing the videos on YouTube, Instagram, TikTok, and LinkedIn — not from the videos themselves. Tool used: [blog2video.app](https://blog2video.app).

## What we asked, and who we asked

Roughly 200 Substack writers using [Blog2Video](https://blog2video.app) volunteered to report back after two weeks of turning their posts into videos. Two weeks is short and the group volunteered rather than being sampled, so treat this as a strong signal rather than a controlled study. I come back to what that caveat costs at the end.
...
## 1. Total audience went up about 4x
...
## 3. Open rate improved by about 20%
...
The version the group ran is not complicated:

1. Take the issue you just published
2. Turn it into a video that follows the same structure
3. Upload it to YouTube, Instagram, TikTok, and LinkedIn with a link back to the post
4. Embed it at the top of the email as well

The reason this is now a few minutes rather than an afternoon is that the video is built from the post you already wrote — your headings, your argument, your examples — instead of being generated from a prompt. That distinction is also why anyone watches it; it is the subject of a [separate piece on the blog](https://blog2video.app/blogs/ai-video-generators-that-are-not-slop).

[Turn your next issue into a video →](https://blog2video.app)
