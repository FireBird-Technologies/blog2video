        ...
        <div className="rounded-2xl overflow-hidden shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_32px_80px_rgba(0,0,0,0.7)] bg-[#0f0f0f]">
          ...
          <div className="relative aspect-video overflow-hidden bg-black">
            {customTemplate && customTemplate.theme ? (
              <CustomPreview theme={customTemplate.theme} name={customTemplate.name} previewImageUrl={customTemplate.preview_image_url ?? undefined} introCode={customTemplate.intro_code || undefined} outroCode={customTemplate.outro_code || undefined} contentCodes={customTemplate.content_codes || undefined} contentArchetypeIds={customTemplate.content_archetype_ids || undefined} designVersion={((customTemplate as any).design_blueprint as { version?: number } | null)?.version} sceneSampleContent={(customTemplate as any).scene_sample_content} sceneFontDefaults={(customTemplate as any).scene_font_defaults} validLayouts={(customTemplate as any).valid_layouts || undefined} frontendFiles={(customTemplate as any).frontend_files || undefined} frontendEntryRel={(customTemplate as any).frontend_entry_rel || undefined} publicAssetUrls={templateId.startsWith("crafted_") ? ((customTemplate as CraftedTemplateItem).public_asset_urls ?? undefined) : undefined} logoUrls={customTemplate.logo_urls ?? undefined} ogImage={customTemplate.og_image ?? undefined} showLoaderOnEmptyOrError={templateId.startsWith("crafted_")} />
            ) : PreviewComp ? (
              <PreviewComp />
            ) : (
        ...
        <div className="rounded-xl overflow-hidden border-2 border-purple-500 shadow-[0_0_0_4px_rgba(124,58,237,0.1)]">
          <div className="relative aspect-video overflow-hidden">
            {demoMode?.templatePreviewOverride && !selectedCustom && !selectedCrafted ? (
              ...
              <CustomPreview theme={selectedCustom.theme} name={selectedCustom.name} previewImageUrl={selectedCustom.preview_image_url} introCode={selectedCustom.intro_code || undefined} outroCode={selectedCustom.outro_code || undefined} contentCodes={selectedCustom.content_codes || undefined} contentArchetypeIds={selectedCustom.content_archetype_ids || undefined} designVersion={(selectedCustom.design_blueprint as { version?: number } | null)?.version} sceneSampleContent={selectedCustom.scene_sample_content} sceneFontDefaults={selectedCustom.scene_font_defaults} logoUrls={selectedCustom.logo_urls} ogImage={selectedCustom.og_image} thumbnailMode={isMobile} staticThumb={isMobile} key={`selected-custom-${selectedCustom.id}-${step}`} />
                      ...
                      <div className="relative isolate h-[70px] overflow-hidden">
                        <div className="relative z-0 h-full">
                          {item.type === "crafted" ? (
                            ...
                            <CustomPreviewLandscape {...({ theme: ct.theme, name: ct.name, introCode: ct.intro_code || undefined, outroCode: ct.outro_code || undefined, contentCodes: ct.content_codes || undefined, contentArchetypeIds: ct.content_archetype_ids || undefined, designVersion: (ct as any).design_blueprint?.version, sceneSampleContent: (ct as any).scene_sample_content, sceneFontDefaults: (ct as any).scene_font_defaults, validLayouts: (ct as any).valid_layouts, frontendFiles: (ct as any).frontend_files, frontendEntryRel: (ct as any).frontend_entry_rel, publicAssetUrls: (ct as any).public_asset_urls, previewImageUrl: ct.preview_image_url, logoUrls: (ct as any).logo_urls, ogImage: (ct as any).og_image, showLoaderOnEmptyOrError: false, thumbnailFrame: 135, thumbnailMode: true, staticThumb } as any)} key={`${customId}-${step}`} />
                          )}
                        </div>
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="rounded-xl overflow-hidden border-2 border-purple-500 shadow-[0_0_0_4px_rgba(124,58,237,0.1)]">
            <div className="relative aspect-video overflow-hidden">
              {selectedCustomBulk ? (
                <CustomPreview theme={selectedCustomBulk.theme} name={selectedCustomBulk.name} previewImageUrl={selectedCustomBulk.preview_image_url} introCode={selectedCustomBulk.intro_code || undefined} outroCode={selectedCustomBulk.outro_code || undefined} contentCodes={selectedCustomBulk.content_codes || undefined} contentArchetypeIds={selectedCustomBulk.content_archetype_ids || undefined} designVersion={(selectedCustomBulk.design_blueprint as { version?: number } | null)?.version} sceneSampleContent={selectedCustomBulk.scene_sample_content} sceneFontDefaults={selectedCustomBulk.scene_font_defaults} logoUrls={selectedCustomBulk.logo_urls} ogImage={selectedCustomBulk.og_image} thumbnailMode={isMobile} staticThumb={isMobile} key={`selected-bulk-custom-${tpl}-${activeIndex}-${step}`} />
