...
/**
 * NewsHeadline — the hero card.
 *
 * Animation sequence (at 30 fps):
 *  0-14   category tag fades in + underline draws
 *  6-30   headline slides up from below
 *  22-44  yellow highlight sweeps across key words (leftThought = "word1,word2")
 *  32-48  thin rule draws across
 *  40-58  narration / subhead fades in
 *  50-68  byline + date fades in
 *
 * Props used:
 *  title           = headline text
 *  narration       = subheadline
 *  leftThought     = comma-separated words to highlight (e.g. "government,funding")
 *  category        = section tag, or stats[0].label
 *  stats[0].value  = author name
 *  stats[1].value  = date string
 */
