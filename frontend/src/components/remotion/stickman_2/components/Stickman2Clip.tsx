...
/**
 * Drop-in video replacement for stickman_2's `<Img>` blocks (stock footage).
 *
 * Each stickman_2 image layout owns its own wrapper styling — Ken Burns motion,
