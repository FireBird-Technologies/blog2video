...
/**
 * Drop-in video replacement for economist's `<Img>` blocks (stock footage).
 *
 * Each economist image layout owns its own wrapper styling — Ken Burns motion,
