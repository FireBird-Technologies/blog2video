...
export const MosaicDataChart: React.FC<MosaicLayoutProps> = ({
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", opacity: fadeOut, background: MOSAIC_BG }}>
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", padding: p ? "6% 7%" : "5% 7%" }}>
        ...
        <div style={{ opacity: titleOp, marginBottom: Math.round(height * 0.018), textAlign: "center" }}>
          ...
          <div style={{ width: 80, height: 3, background: accent, margin: `${Math.round(height * 0.012)}px auto 0`, opacity: 0.85, borderRadius: 2 }} />
        </div>
