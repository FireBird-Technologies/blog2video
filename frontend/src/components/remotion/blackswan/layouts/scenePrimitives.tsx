...
/** Letter fill alpha — dim tube interior; rim comes from stroke + text-shadow. */
...
/** Tight edge / rim glow only — short blur so nearby body copy stays clean. */
...
/** Dim interior (`fillHex`), bright glyph edge (accent stroke), short outer glow. */
