...
/**
 * BBC-TV inspired clean background:
 * - flat white base (no newspaper texture)
 * - subtle scanlines
 * - optional red headline strip
 */
export const BbcNewsBackground: React.FC<{
  ...
  const stripOpacity = mode === "breaking" ? Math.max(0.62, Math.min(1, 0.86 + 0.12 * Math.sin(frame * 0.07))) : 0.0;
