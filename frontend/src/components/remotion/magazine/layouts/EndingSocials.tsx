...
export const EndingSocials: React.FC<SceneLayoutProps> = (props) => {
  ...
  return (
    <MagazinePage lightChrome colors={colors} section="Colophon" issue={props.issueLabel ?? "Fin"} page={props.pageNumber} aspectRatio={props.aspectRatio} fontFamily={props.fontFamily} singlePage cameraMove={props.cameraMove}>
