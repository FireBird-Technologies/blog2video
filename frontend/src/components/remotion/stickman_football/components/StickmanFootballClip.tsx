...
/**
 * Drop-in video replacement for stickman_football's `<Img>` blocks (stock footage).
 *
 * Each stickman_football image layout owns its own wrapper styling — Ken Burns motion,
 ...
 */
export function StickmanFootballClip({
  src,
  imageObjectPosition,
  imageZoom,
  muted = true,
