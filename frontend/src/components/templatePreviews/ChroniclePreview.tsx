...
const PREVIEW_SCENES: ChronicleSceneInput[] = [
  ...
  },
  {
    ...
    narration:
      "In the age of kings and quills, scribes set forth the events of the realm in flowing ink upon parchment.",
  ...
  },
  {
    id: 3,
    order: 3,
    title: "The Writ Remembered",
    narration: "What is written in ink outlives the flesh.",
    layout: "illuminated_quote",
    layoutProps: {
      titleFontSize: 58,
      descriptionFontSize: 20,
      quote: "What is written in ink outlives the flesh.",
      attribution: "The Chronicler",
      highlightPhrase: "ink",
    },
    durationSeconds: 3.0,
  },
  {
    ...
    narration: "Numbers, as they have always been, etched into memory.",
    layout: "ledger_stats",
    layoutProps: {
      titleFontSize: 58,
      descriptionFontSize: 19,
      stats: [
        { value: "1215", label: "Magna Carta" },
        { value: "40", label: "Barons" },
        { value: "VII", label: "Centuries" },
      ],
    },
    durationSeconds: 3.0,
  },
