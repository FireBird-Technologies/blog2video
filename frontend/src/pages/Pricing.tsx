    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="border-b border-gray-200/50 bg-white/60 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            {user ? (
              <a href="/dashboard" className="text-sm text-gray-400 hover:text-gray-900 transition-colors">Dashboard</a>
            ) : (
              <a href="/" className="text-sm text-gray-400 hover:text-gray-900 transition-colors">Home</a>
            )}
          </div>
        </div>
      </nav>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 pt-20 pb-10 text-center">
          ...
          <p className="text-lg text-gray-500 max-w-xl mx-auto leading-relaxed">
            Start with a free video. Upgrade when you need more power.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          <div className="glass-card p-8 flex flex-col">
            ...
            <ul className="space-y-4 mb-10 flex-1">
              {[
                ...
                "Professional ElevenLabs voiceover",
                "4 voice options (male/female, UK/US)",
                "Remotion video preview",
                "Render to MP4 & download",
              ].map((f) => (
            ...
            {user ? (
              <button
                disabled
                className="w-full py-3 px-4 rounded-lg text-sm font-medium bg-gray-100 text-gray-400 cursor-not-allowed"
              >
          ...
          {/* Pro */}
          <div className="glass-card p-8 flex flex-col ring-2 ring-purple-200 relative">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-400">For serious content creators</p>
            </div>
            <div className="mb-8">
            ...
            <ul className="space-y-4 mb-10 flex-1">
              {[
                ...
                "Remotion video preview",
                "Render to MP4 & download",
                "AI chat editor — refine scenes on the fly",
            ...
            {user ? (
              isPro ? (
                <button
                  disabled
                  className="w-full py-3 px-4 rounded-lg text-sm font-medium bg-purple-50 text-purple-400 cursor-not-allowed"
                >
                  Current plan
                </button>
              ) : (
      ...
      <div className="max-w-3xl mx-auto px-6 pb-20">
        <h3 className="text-lg font-semibold text-gray-900 text-center mb-8">Compare plans</h3>
        <div className="glass-card overflow-hidden">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="text-left py-4 px-6 font-medium text-gray-500">Feature</th>
                <th className="py-4 px-6 font-medium text-gray-500 text-center">Free</th>
                <th className="py-4 px-6 font-medium text-purple-600 text-center">Pro</th>
              </tr>
            </thead>
            <tbody>
              {[
                { feature: "Videos per month", free: "1", pro: "100" },
                { feature: "AI script generation", free: true, pro: true },
                { feature: "ElevenLabs voiceover", free: true, pro: true },
                { feature: "Voice selection (4 options)", free: true, pro: true },
                { feature: "Video preview", free: true, pro: true },
                { feature: "Render & download MP4", free: true, pro: true },
                { feature: "AI chat editor", free: false, pro: true },
                { feature: "Remotion Studio access", free: false, pro: true },
                ...
                <tr key={row.feature} className={i % 2 === 0 ? "bg-gray-50/50" : ""}>
                  ...
                  <td className="py-3.5 px-6 text-center">
                    {typeof row.pro === "boolean" ? (
                      row.pro ? <GreenCheck /> : <GrayX />
                    ) : (
                      <span className="font-medium text-gray-900">{row.pro}</span>
                    )}
                  </td>
                </tr>
              ))}
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              a: "Free users can preview and download. Pro users get access to the AI chat editor (tell the AI to rewrite scenes) and full Remotion Studio for manual editing.",
            },
            {
            ...
            <div key={faq.q} className="glass-card p-6">
              <h4 className="text-sm font-medium text-gray-900 mb-2">{faq.q}</h4>
...
function GreenCheck() {
  return (
    <svg className="w-4 h-4 text-purple-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
    </svg>
  );
}
