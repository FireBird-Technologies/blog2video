...
const SCENE_SETS: Record<string, SceneSet> = {
  ...
  "preview-whiteboard": {
    ...
    scenes: [
      {
        id: 1, order: 1, title: "Story Comes Alive", durationSeconds: 7,
        narration: "Hand-drawn markers, playful stick figures and clear story beats bring every idea to life.",
        layout: "drawn_title",
        layoutProps: {
          titleFontSize: 90,
      ...
      {
        id: 2, order: 2, title: "By the Numbers", durationSeconds: 7,
      ...
      {
        id: 3, order: 3, title: "Make a Choice", durationSeconds: 7,
      ...
      {
        id: 4, order: 4, title: "The Impact", durationSeconds: 7,
      ...
      {
        id: 5, order: 5, title: "The Big Conversation", durationSeconds: 7,
        narration: "",
        layout: "speech_bubble_dialogue",
        layoutProps: {
          leftThought: "Hey, did you know?",
          rightThought: "No way — tell me more!",
      ...
      {
        id: 6, order: 6, title: "Get Ready!", durationSeconds: 7,
  ...
  "preview-gridcraft": {
    ...
    scenes: [
      {
        id: 1, order: 1, title: "Gridcraft", durationSeconds: 7,
        narration: "Bento editorial in motion — a template system that turns structured content into a living, glassy grid.",
        layout: "bento_hero",
        layoutProps: {
          title: "Gridcraft",
          subtitle: "Bento editorial in motion",
          category: "Template System",
          icon: "🎨",
        },
      },
      {
        id: 2, order: 2, title: "Everything You Need", durationSeconds: 7,
        narration: "Six capabilities, one composable grid — everything you need to ship, secured and scaled by default.",
        layout: "bento_features",
        layoutProps: {
          highlightIndex: 2,
          features: [
      ...
      {
        id: 3, order: 3, title: "By the Numbers", durationSeconds: 7,
        narration: "The results speak for themselves — near-perfect uptime, low latency, and real cost savings.",
        layout: "kpi_grid",
        layoutProps: {
          highlightIndex: 0,
          dataPoints: [
            { label: "Uptime SLA", value: "99.99%", trend: "up" },
            { label: "P95 Latency", value: "15ms", trend: "down" },
            { label: "Cost Savings", value: "3.2×", trend: "up" },
          ],
        },
      },
    ],
  ...
  "preview-newspaper": {
    ...
    scenes: [
      {
        id: 1, order: 1, title: "Partial government shutdown begins as funding lapses", durationSeconds: 7,
        narration: "Despite a Senate deal, the House failed to pass the bill before midnight.",
        layout: "news_headline",
        layoutProps: {
          category: "Politics",
      ...
      {
        id: 2, order: 2, title: "The Story", durationSeconds: 7,
        narration: "Lawmakers failed to pass a short-term spending bill before the midnight deadline, triggering a partial government shutdown that will affect hundreds of thousands of federal workers starting today.",
        layout: "article_lead",
        layoutProps: {
      ...
      {
        id: 3, order: 3, title: "Real people will feel real consequences starting tomorrow morning.", durationSeconds: 7,
      ...
      {
        id: 4, order: 4, title: "By the Numbers", durationSeconds: 7,
        narration: "",
        layout: "data_snapshot",
        layoutProps: {
          stats: [
      ...
      {
        id: 5, order: 5, title: "Fact Check", durationSeconds: 7,
        narration: "⚠ Context needed — no evidence supports the claim based on historical precedent.",
        layout: "fact_check",
        layoutProps: {
      ...
      {
        id: 6, order: 6, title: "How We Got Here", durationSeconds: 7,
        narration: "",
        layout: "news_timeline",
        layoutProps: {
          stats: [
