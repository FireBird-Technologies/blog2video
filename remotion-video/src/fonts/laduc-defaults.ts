 ...
 *
 * This module is imported for side effects by the LaDuc Remotion composition.
 * It registers the FunctionPro family so CSS `font-family: 'FunctionPro'`
 * resolves during Remotion browser rendering.
 */
