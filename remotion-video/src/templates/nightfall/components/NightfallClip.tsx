...
/**
 * Drop-in video replacement for Nightfall's `<Img>` blocks (stock footage).
 *
 * Each Nightfall image layout owns its own wrapper styling — Ken Burns motion,
