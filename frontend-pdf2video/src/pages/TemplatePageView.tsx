...
/**
 * /templates/custom shows a REAL brand-extracted template, same as ../frontend:
 * FirebirdCustomPreview fetches featured public templates (FireBird id 13,
 * Metal id 46 as fallback) and renders them through the CustomPreview
 * compiler, rather than a built-in Remotion composition.
 */
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main>
        ...
        {templateProfile && (slug === "custom" || templateProfile.previewSceneKey) && (
          <section className="border-b border-gray-100 bg-gray-50/50">
            <div className="mx-auto max-w-5xl px-6 py-16">
              <p className="mb-2 text-center text-xs font-semibold uppercase tracking-[0.2em] text-purple-600">
                Live Preview
              </p>
          ...
          <section className="border-y border-gray-100 bg-gray-50/70">
            <div className="mx-auto max-w-6xl px-6 py-16">
              ...
              <p className="mt-3 max-w-2xl text-base text-gray-500">
                Each layout is automatically selected based on the content type in your document.
                You can also override layouts manually in the scene editor.
              </p>
        ...
        {(() => {
          ...
          const next =
            currentIdx >= 0 && currentIdx < visibleTemplateProfiles.length - 1
              ? visibleTemplateProfiles[currentIdx + 1]
              : null;
