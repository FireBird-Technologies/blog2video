...
import { getBlogPost, getRelatedBlogPosts, getStructuredInternalLinks, siteUrl } from "../content/siteContent";
import NotFoundPage from "./NotFoundPage";
import { blogPostSchema } from "../seo/schema";

/**
 * Minimal by design: unlike ../frontend/src/pages/BlogPostPage.tsx, this file
 * has no per-article special-case embeds (YouTube stickman films, "compare
 * us to X" widgets, etc.) — those were all keyed to specific blog2video.app
 * article slugs that don't exist in this deployment's (currently empty, see
 * content/blogPosts.ts) post list. Add embeds back here only for PDF2Video's
 * own articles as they're written.
 */
              ...
              {post.sections.map((section) => (
                <section key={section.heading}>
                  ...
                  {section.ctaPath && (
                    ...
                    >
                      {section.ctaLabel || "Try PDF2Video free"}
