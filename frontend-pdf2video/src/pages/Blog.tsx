...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <Seo
        title="Blog"
        description="Document-to-video workflows, PDF report distribution, and research publishing playbooks for PDF2Video."
        path="/blogs"
        ...
        <section className="border-b border-gray-100 bg-gradient-to-b from-purple-50/40 via-white to-white">
          <div className="mx-auto max-w-6xl px-6 py-20">
            ...
            <h1 className="max-w-4xl text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
              Turning documents into video, one workflow at a time
            </h1>
            <p className="mt-5 max-w-3xl text-lg leading-relaxed text-gray-500">
              Notes on distributing PDFs, reports, and research as video — for analysts,
              publishers, and teams who write documents nobody finishes reading.
            </p>
          </div>
        </section>
        ...
        {!featuredPost ? (
          <section className="mx-auto max-w-6xl px-6 py-20 text-center">
            <p className="text-sm text-gray-500">
              We're just getting started here — first posts are on the way.
            </p>
          </section>
        ) : (
          <>
                ...
                <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
                  ...
                  >
                    <div className="mb-6 overflow-hidden rounded-2xl border border-gray-100 bg-gray-50">
                      <img
                        src={featuredPost.heroImage || "/og-image-v2.png"}
                  ...
                  <div className="rounded-3xl border border-gray-200 bg-gray-50/70 p-8">
                    ...
                    <div className="mt-6 space-y-4 text-sm text-gray-600">
                      <p>Turning PDFs, reports, and whitepapers into narrated video.</p>
                      <p>Distribution playbooks for analysts, researchers, and consultants.</p>
                      <p>Document structure, templates, and production workflows.</p>
                    </div>
                  </div>
                </div>
              </section>
